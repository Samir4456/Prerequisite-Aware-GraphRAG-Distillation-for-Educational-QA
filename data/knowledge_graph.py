        ...
        if result and "concepts" in result:
            for c in result["concepts"]:
                ...
                concepts.append({
                    ...
                    "prerequisites": [p.strip().lower() for p in c.get("prerequisites", []) if isinstance(p, str) and p.strip()],
                    "enables":       [e.strip().lower() for e in c.get("enables", []) if isinstance(e, str) and e.strip()],
                })
